...
@Component({
  ...
  template: `
    ...
    <div class="callout">
      ...
      recovery, env passthrough both ways (your variables reach the command, a parked workload's reach it too, yours winning, and <code>-c --env-of</code> reads a running workload's without taking it over), the reverse direction (a cluster workload - and an
  ...
  protected readonly sections: Section[] = [
    {
      ...
      rows: [
        ...
        { feat: 'amd64 <em>and</em> arm64', os: ['ok', 'ok', 'ok'], note: 'six binaries; Windows arm64 native, no WSL2, and its WinTUN driver is exercised on a windows-11-arm CI runner' },
    ...
    },
    {
      ...
      rows: [
        ...
        { feat: 'Native selftest (datapath proof)', os: ['ok', 'ok', 'ok'], note: 'green on all three in CI, plus a windows-11-arm leg opening a real arm64 WinTUN device' },
