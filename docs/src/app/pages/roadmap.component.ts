  ...
  template: `
    ...
    <table>
      ...
      <tbody>
        ...
        <tr><td>Takeover (<code>--takeover</code>): park the deployed service owning a <code>-s</code> name for the session, restore it on exit</td><td><mat-icon class="status-icon ok">check_circle</mat-icon> shipped</td></tr>
