  ...
  template: `
    ...
    <table>
      ...
      <tbody>
        ...
        <tr><td>Reverse direction: serve a local port to the cluster under a cluster name (<code>-s</code>)</td><td><mat-icon class="status-icon ok">check_circle</mat-icon> shipped</td></tr>
