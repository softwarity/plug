...
- [x] **Le correctif du témoin k8s est livré en 2.11.1 SANS note - FAIT** (commit `867f348`, « 2.11.1 tells both of the fixes it shipped ») : la release a été lancée avant que la note soit écrite. À rédiger sous `NEXT RELEASE` en précisant qu'elle décrit du déjà-livré - jamais dans la section publiée.
